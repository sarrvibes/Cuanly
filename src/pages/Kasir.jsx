...
export default function Kasir() {
    ...
    async function eksekusiPembayaran(e) {
        ...
        try {
            ...
            // 3. UPDATE STOK DB (BAGIAN INI SUDAH DIHAPUS AGAR TIDAK ERROR)
                ...
                {filteredProduk.map((item) => {
                    ...
                    return (
                        <div
                            ...
                            className="bg-white border border-[#dcc3aa] rounded-2xl p-4 flex flex-col justify-between h-44 shadow-xs transition-all relative select-none hover:shadow-md cursor-pointer hover:border-[#810b38] active:scale-98"
                        >
                            {/* Info Atas Card */}
                            <div>
